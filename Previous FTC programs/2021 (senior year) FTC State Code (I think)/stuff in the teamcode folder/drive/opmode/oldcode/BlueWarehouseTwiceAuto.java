...
public class BlueWarehouseTwiceAuto extends LinearOpMode {
    ...
    double distanceSensitivity = 1.25;
...
//                        }
                ...
                case TRAJECTORY_4: //go back to hub, run the intake until the block is at the distance sensor, then runs the lift,
                    ...
                    if(drive.Lift.getCurrentPosition()<(1680+AmountofBlocksGotten*50) && donewithIntake) {
                        ...
                        telemetry.addData("Is pressure plate touched or sensor?",drive.IntakeTouch1.isPressed()||drive.IntakeTouch2.isPressed()&&drive.IntakeColor.alpha()>100);
                ...
                case IntakeUntilTouchSensor:
                    ...
                    if ((donewithIntake||hasABlock)&&AmountofBlocksGotten<3 && TotalTime.seconds()<30) { //If we still have time to keep going:
                        ...
                        TrajectorySequence trajectory4 = drive.trajectorySequenceBuilder(poseEstimate)
                                ...
                                .splineToSplineHeading(new Pose2d(-11.75, 44.25-AmountofBlocksGotten*0),Math.toRadians(90))
                                .splineToSplineHeading(new Pose2d(-11.75, 39.25-AmountofBlocksGotten*0,Math.toRadians(90)),Math.toRadians(90))
                                .build();
