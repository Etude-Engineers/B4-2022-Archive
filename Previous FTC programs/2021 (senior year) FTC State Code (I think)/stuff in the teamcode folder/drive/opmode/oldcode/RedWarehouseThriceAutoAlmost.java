...
@Disabled
public class RedWarehouseThriceAutoAlmost extends LinearOpMode {
                    ...
                    if (!drive.isBusy()) {
                        ...
                        if(AmountofBlocksGotten>1)
                        {
                            TrajectorySequence trajectory3_2 = drive.trajectorySequenceBuilder(trajectory2.end())
                                    .splineToSplineHeading(new Pose2d(16.5,-65.5, Math.toRadians(0)),Math.toRadians(0)) //At Barrier, off by 1.5 in in y
                                    .splineToConstantHeading(new Vector2d(46,-65),Math.toRadians(0))
                                    .build();
