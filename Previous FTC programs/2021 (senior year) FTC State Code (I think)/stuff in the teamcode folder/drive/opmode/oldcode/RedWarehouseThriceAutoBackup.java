...
@Disabled
public class RedWarehouseThriceAutoBackup extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence SpeedDetect = drive.trajectorySequenceBuilder(startingPosition) //Goes to Scan:
                .splineTo(new Vector2d(6.625, -45.675),Math.toRadians(90)) //y was like 4 inches too little, x was like an inch too little
                .splineTo(new Vector2d(-12.75, -39.25),Math.toRadians(90))
                .build();
...
//        currentState = BlueWarehouseThriceAuto.State.ScanAndScore; //Goes to blocks
...
//                        }
                ...
                case IntakeUntilTouchSensor:
                    ...
                    if ((donewithIntake||hasABlock)&&AmountofBlocksGotten<(GoalBlocksToGet+1) && TotalTime.seconds()<WhenTooLittleTimeIsLeft) { //If we still have time to keep going:
                        ...
                        if(hasABlock)
                        {
                            telemetry.addData("A block touched the touch sensor!","Going to go score now");
                            telemetry.update();
