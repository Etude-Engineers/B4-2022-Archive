...
public class RedDuckWebcamAutoNoCap extends LinearOpMode {
...
//    Boolean hasDetected = false;
    ...
    Pose2d poseEstimate = new Pose2d(-35.25, -58.75, Math.toRadians(270));
    //TODO: Try inital pose
    Pose2d startingPosition = new Pose2d(-35.25, -58.75, Math.toRadians(270)); //If we Spin First, off by 1.5in
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence DriveToHub = drive.trajectorySequenceBuilder(poseEstimate) //Goes to Hub:
                .setReversed(true)
                .splineTo(new Vector2d(-58,-37.5),Math.toRadians(90))
                .splineTo(new Vector2d(-58,-24),Math.toRadians(90))
                .splineTo(new Vector2d(-28.5,-18),Math.toRadians(-2))
                .build();
...
//                        drive.Lift.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
                        ...
                        TrajectorySequence DumpLowerGoToSpinDuck = drive.trajectorySequenceBuilder(poseEstimate)
                                .setReversed(false)
                                .splineTo(new Vector2d(-56,-20),Math.toRadians(180))
...
//                            drive.Intake.setPower(1);
                            ...
                            Pose2d DUCK_COLLECT1 = new Pose2d(-55, -59.5, Math.toRadians(270));
                            Pose2d DUCK_COLLECT2 = new Pose2d(-35, -59.5, Math.toRadians(270));
