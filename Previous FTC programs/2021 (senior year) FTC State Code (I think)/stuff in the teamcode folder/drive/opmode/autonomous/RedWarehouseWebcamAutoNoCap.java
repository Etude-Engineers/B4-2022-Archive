...
public class RedWarehouseWebcamAutoNoCap extends LinearOpMode {
...
//        IntakeUntilTouchSensor, //Drive forward slowly and run the intake until we sense we have a block in our intake
    ...
    static double HowfarIntoWarehouseRobotGoes = (27.5+12.5);
...
//                                .strafeLeft(2)
                                    ...
                                    .splineTo(new Vector2d(-11, -41 + AmountofBlocksGotten * HubIncrement), Math.toRadians(85))
                                    .build();
                        }
